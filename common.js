...
function populatelist(types,years){
	...
	for(i=0;i<data.length;i++){
			if(types=="appeal"){
			if(data[i].label==0){
			$('ul#'+types+years).append("<li><a href='appeal.html?id="+data[i].id+"' id='"+data[i].id+"'>"+data[i].title+" ["+ data[i].type+ "]</a></li>")}
...
donut = function(radius,covered,text1,text2){
	...
	if (percentremain>0.5) {return "<svg viewBox='0 0 "+radius*2+" "+radius*2+"' id='donut'><g transform='translate("+radius*2+","+radius*2+") scale(1,-1) rotate(90)'><path fill='#0094cc' class='remain' d='M"+r+","+r+" h"+r+" a"+r+","+r+" 0 1,1 "+x+","+y+" z'/><path fill='#026BB5' class='commit' d='M"+r+","+r+" h"+r+" a"+r+","+r+" 0 0,0 "+x+","+y+" z'/><circle fill='#ABE0F9' r='"+radius*(3/5)+"' cx='"+radius+"' cy='"+radius+"'/></g><text id='text1' fill='#FFF' x='"+parseFloat(radius-27)+"' y='"+parseFloat(radius+2)+"' font-size='25'>"+text1+"</text><text id='text2' fill='#FFF' x='"+parseFloat(radius-26)+"' y='"+parseFloat(radius+14)+"'>"+text2+"</text></svg>";}
	else {return "<svg viewBox='0 0 "+radius*2+" "+radius*2+"' id='donut'><g transform='translate("+radius*2+","+radius*2+") scale(1,-1) rotate(90)'><path fill='#0094cc' class='remain' d='M"+r+","+r+" h"+r+" a"+r+","+r+" 0 0,1 "+x+","+y+" z'/><path fill='#026BB5' class='commit' d='M"+r+","+r+" h"+r+" a"+r+","+r+" 0 1,0 "+x+","+y+" z'/><circle fill='#ABE0F9' r='"+radius*(3/5)+"' cx='"+radius+"' cy='"+radius+"'/></g><text id='text1' fill='#FFF' x='"+parseFloat(radius-27)+"' y='"+parseFloat(radius+2)+"' font-size='25'>"+text1+"</text><text id='text2' fill='#FFF' x='"+parseFloat(radius-26)+"' y='"+parseFloat(radius+14)+"'>"+text2+"</text></svg>";}
}
